         ...
         <div class="films-home">
            <section class="banner-section position-relative">
               <transition name="fade" mode="out-in">
                  <img :key="banners[currentBanner]" :src="banners[currentBanner]" alt="Banner" class="banner-img" />
               </transition>
            ...
            <section id="now" class="container-fluid section-films py-5">
               ...
               <Swiper v-else :modules="modules" :slides-per-view="4" :space-between="24" :loop="true"
                  ...
                  <SwiperSlide v-for="film in nowShowingFunc()" :key="film.id">
                     <div class="card film-card h-100 border-0" @mouseenter="hoverFilm = film.id"
                        ...
                        <div class="poster-wrapper position-relative">
                           ...
                           <div class="film-overlay" v-if="hoverFilm === film.id" @click="openTrailer(film)">
                  ...
                  <SwiperSlide v-for="film in comingSoonFunc()" :key="film.id">
                     <div class="card film-card h-100 border-0" @mouseenter="hoverFilm = film.id"
                        ...
                        <div class="card-body">
                           ...
                           <div class="film-buttons d-flex justify-content-center gap-2">
                              <router-link :to="`/film/${film.id}`" class="btn-film flex-grow-1">Mua vé</router-link>
                              <router-link :to="`/film/${film.id}`" class="btn-film-outline flex-grow-1">
                                 Chi tiết
                              </router-link>
                           </div>
