  ...
  <div class="forgot-container">
    <div class="card shadow-lg border-0 p-4 mx-auto animate__animated animate__fadeIn">
      ...
      <div v-else-if="step === 2" class="step-content">
        ...
        <button class="btn btn-green w-100" @click="verifyOtp">XÁC NHẬN OTP</button>
...
async function sendOtp() {
  ...
  try {
    ...
    Swal.fire("Thành công", res.data.message || "Đã gửi OTP đến email!", "success");
    step.value = 2;
  } catch (error) {
    Swal.fire(
      "Lỗi",
...
async function resetPassword() {
  ...
  try {
    ...
    Swal.fire("Thành công", res.data.message || "Đặt lại mật khẩu thành công!", "success");
    step.value = 4;
  } catch (error) {
    Swal.fire(
      "Lỗi",
