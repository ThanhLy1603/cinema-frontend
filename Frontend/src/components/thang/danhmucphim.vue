<template>
  <div class="categories-page">
    <div class="header">
      ...
      <button class="btn primary" @click="createCategory">+ Thêm danh mục</button>
    </div>
    ...
    <form @submit.prevent="createCategory" class="form-card">
      <div class="grid">
        ...
        <div class="field">
          <label>Mô tả</label>
          <textarea v-model="category.description" placeholder="Mô tả ngắn..."></textarea>
        </div>
      </div>
  ...
  setup() {
    ...
    async function createCategory() {
      try {
        ...
        console.error(err);
        showToast("Thêm danh mục thất bại!", "error");
      }
    }
